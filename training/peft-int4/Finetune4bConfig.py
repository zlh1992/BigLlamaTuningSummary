# -*- coding: utf-8 -*-
# @Time : 2023/6/17 下午9:11
# @Author : zhenglinghan
# @Email : zhenglinghan.zlh@antgroup.com
# @File : Finetune4bConfig.py
# @Project : LLM
...
class Finetune4bConfig:
    ...
    def __init__(self, dataset: str, ds_type: str,
                 ...
                 local_rank: int, flash_attention: bool, xformers: bool, backend: str, max_memory: int, max_memory_cpu: int
                 ):
        """
        Args:
            ...
            max_memory (int) max memory for training model in each GPU device optimal value is half of the memory of GPU devices
            max_memory_cpu (int) max memory for training model in cpu optimal value is three times of --max_memory
        """
