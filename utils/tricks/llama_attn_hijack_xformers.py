# -*- coding: utf-8 -*-
# @Time : 2023/6/15 下午5:08
# @Author : zhenglinghan
# @Email : zhenglinghan.zlh@antgroup.com
# @File : llama_attn_hijack_xformers.py
# @Project : LLM
...
def xformers_forward(
    ...
    query_states, key_states = transformers.models.llama.modeling_llama.apply_rotary_pos_emb(query_states, key_states,
