# -*- coding: utf-8 -*-
# @Time : 2023/6/15 下午5:23
# @Author : zhenglinghan
# @Email : zhenglinghan.zlh@antgroup.com
# @File : peft_tuners_lora_monkey_patch.py
# @Project : LLM
            ...
            if target_module_found:
                ...
                if isinstance(target, LoraLayer):
                    ...
                    if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
                        ...
                        new_module = Linear4bitLt(adapter_name, target.in_features, target.out_features,
                                                  target.groupsize, target.is_v1_model, bias=bias, **kwargs)
                    else:
